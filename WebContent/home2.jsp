...
<div class="container">
	...
	<div class="headerwrapper">
		<div class="logo">
			...
			<button type="submit" class="btn btn-success navbar-btn"  style="margin-left:570px;" 
			onclick="lub()">Logout</button>
		</div>
	</div>
		
	<div class="container-fluid">
		<ul class="nav nav-tabs">
  			<li role="presentation" ><!-- class="active" --><a href="home2.jsp">Home</a></li>
			...
			<ul class="dropdown-menu" role="menu">
				<li><a href="pgprogram2.html">P.G Programs</a></li>
				<li><a href="diploma2.html">Diploma Programs</a></li>
				<li><a href="corporate2.html">Corporate Programs</a></li>
				<li><a href="cyberlaw2.html">Cyber Law Programs</a></li>
			</ul>
			</li>
			...
			<ul class="dropdown-menu" role="menu">
				<li><a href="english2.html">English Wings</a></li>
				<li><a href="history2.html">History Wings</a></li>
				<li><a href="economic2.html">Economics Wings</a></li>
				<li><a href="commerce2.html">Commerce Wing</a></li>
			</ul>
		</li>
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu" role="menu">
				<li><a href="apply2.html">How to Apply</a></li>
				<li><a href="appform2.html">Apply Online</a></li>
				<li><a href="notice2.html">News & Notices</a></li>
				<li><a href="advantage2.html">Advantages of Our University</a></li>
			</ul>
		</li>
	...
	<div class="container-fluid" style="margin-left:-10px;padding:5px;">
          ...
          <a href="appform2.html"><button type="button" class="btn btn-default btn-block">Application Form</button></a>
          <a href="index.jsp"><button type="button" class="btn btn-default btn-block">Student Zone</button></a>
          <a href="#"><button type="button" class="btn btn-default btn-block">Assignments</button></a>
          <a href="faq2.html"><button type="button" class="btn btn-default btn-block">FAQs</button></a>
          </ul>
          ...
          <div class="boxed" rows="3" style="border: 3px solid grey ; float:right; width:200px;height:250px;
  			...
  			<marquee 
                 ...
                 <a href="notice2.html">Notice for online application form 2014-15</a>
            </marquee>
          </div> 
          ...
          <p style= "font-size:25px;color:red;text-align:center;margin-top:280px;
			           ...
			           style="margin-left:210px"><a href="appform2.html">**Click Here to Apply Online for Programs**</a></marquee></p>
